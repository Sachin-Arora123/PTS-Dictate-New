...
#import "WBReminderGradientView.h"

@implementation WBReminderNoticeView

+ (WBReminderNoticeView *)reminderNoticeInView:(UIView *)view title:(NSString *)title message:(NSString *)message
{
    WBReminderNoticeView *notice = [[WBReminderNoticeView alloc]initWithView:view title:title];
...
//    NSString *noticeIconImageName = [path stringByAppendingPathComponent:@"notice_error_icon.png"];
    ...
    self.gradientView = [[WBReminderGradientView alloc] initWithFrame:CGRectMake(0.0, 0, viewWidth, noticeViewHeight + 10.0)];
    [self.view addSubview:self.gradientView];
    
    
    // Make and add the icon view
    UIImageView *iconView = [[UIImageView alloc]initWithFrame:CGRectMake(10.0, 10.0, 32, 32)];
   // iconView.image = [UIImage imageNamed:IMG_APP_LOGO];
